...
SECRET_KEY = 'django-insecure-y*%rutdf54%5uuz2p216_!3#4%mfb_r8q%s9d66!p)6$u1n(#='
...
CSRF_TRUSTED_ORIGINS = [
    'http://127.0.0.1:8000', # 后端自己的地址
    'http://127.0.0.1',      # 覆盖所有127.0.0.1的端口
]
