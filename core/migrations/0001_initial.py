...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('meal_type', models.CharField(choices=[('breakfast', '早餐'), ('lunch', '午餐'), ('dinner', '晚餐'), ('snack', '加餐')], max_length=20, verbose_name='餐次类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calories_calculated', models.FloatField(blank=True, verbose_name='计算卡路里(大卡)')),
                ('food_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.fooditem', verbose_name='食物条目')),
                ('meal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meal_items', to='core.meal')),
            ],
        ),
        migrations.CreateModel(
            name='SleepRecord',
            fields=[
                ...
                ('duration', models.DurationField(blank=True, null=True, verbose_name='睡眠时长')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_date', models.DateField(auto_now_add=True, verbose_name='记录日期')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sport_records', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
